...
- Reception ends 10:00pm — plan to stay on later into the night than a standard cutoff
...
1. Hair/makeup start time (location's set — Embassy Suites for the bride's side)
2. Preferred timing for the two first looks within the 2:00–5:00 window
3. Who's the designated "corraller" for family formals (keeps groupings from dragging)
4. Wedding date, to pin down actual sunset time
...
| Reception (ends 10:00pm) | Per venue/DJ timeline — planning to stay later into the night |

## Next steps
1. Send draft email to Sarah with the open questions above.
2. Lock real times once hair/makeup start, first-look timing, and sunset time are known.
